...
local HINTS = {
    ...
    zonesnap   = { t = "enum", items = { "old behaviour", "one instant", "off the gun you see", "one instant, held steady" }, values = { 0, 1, 2, 3 } },
...
local LABELS = {
    ...
    reloadmagasset = "Which magazine you carry", zonesnap = "When the gun and your hand are measured",
