...
local HINTS = {
    ...
    shotgunlog     = { t = "enum", items = { "off", "shotguns only", "every weapon" }, values = { 0, 1, 2 } },
    meleeleftlog   = { t = "bool" },
    holsterthrowlog = { t = "bool" },
...
local LABELS = {
    ...
    reloadholdfire = "No firing while the magazine is out", reloadvrlog = "Record the reload gesture", reloadresetholds = "Clear the reload after a death or a ride", shotgunlog = "Record every reload value",
    meleeleftlog = "Record the other hand's swings", holsterthrowlog = "Record grenade throws",
