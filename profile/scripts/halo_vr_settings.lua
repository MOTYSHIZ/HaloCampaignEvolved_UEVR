...
local HINTS = {
    ...
    scopelenslumen = { t = "enum", items = { "the game's own setting", "none", "same as the main view", "cheaper approximation" }, values = { -1, 0, 1, 2 } },
    scoperes       = { t = "drag", min = 128, max = 2048, int = true },
    ...
    palettetwohandmin = { t = "drag", min = 0, max = 2 },
    palettetwohandmax = { t = "drag", min = 0, max = 2 },
    palettetwohandagreemin = { t = "drag", min = -1, max = 1 },
    palettetwohandagreefull = { t = "drag", min = -1, max = 1 },
    palettetwohandlog = { t = "bool" },
    reloadmagbelt  = { t = "text" },
    reloadmagasset = { t = "enum", items = { "Whatever ammunition model fits", "The weapon's own magazine only" }, values = { 0, 1 } },
    zonesnapshot   = { t = "enum", items = { "old behaviour", "one instant", "off the gun you see", "one instant, held steady" }, values = { 0, 1, 2, 3 } },
    meleeleftspeed = { t = "drag", min = 0, max = 20 },
    meleeleftext   = { t = "drag", min = 0, max = 20 },
    meleeleftreach = { t = "drag", min = 0, max = 2 },
    meleeleftmaxspeed = { t = "drag", min = 1, max = 100 },
    meleeleftmaxreach = { t = "drag", min = 0.3, max = 5 },
    meleelefttau   = { t = "drag", min = 0, max = 200 },
    meleeleftcooldown = { t = "drag", min = 0, max = 5000, int = true },
    meleelefthold  = { t = "drag", min = 8, max = 1000, int = true },
    gripexclusive  = { t = "bool" },
    reloadakmute   = { t = "slider", min = 0, max = 4, int = true },
    reloadakmimic        = { t = "slider", min = 0, max = 7, int = true },
    reloadcoophide       = { t = "bool" },
    reloadhidesolo       = { t = "bool", needs = { "reloadcoophide" } },
    meleeleft      = { t = "bool" },
...
local LABELS = {
    ...
    palettecalibkey = "Weapon placement calibration key", palettewpncalibkey = "This weapon's placement calibration key",
    ...
    reloadmagasset = "Which magazine you carry", zonesnapshot = "When the gun and your hand are measured",
    ...
    meleeleftlog = "Record the other hand's swings", holsterpollthrowlog = "Record grenade throws",
    grenadeswallowlog = "Record the grenade button strip",
    palettetwohandmin = "Two-handed hold: closest grip", palettetwohandmax = "Two-handed hold: furthest grip",
    palettetwohandagreemin = "Two-handed hold: agreement to start", palettetwohandagreefull = "Two-handed hold: agreement for full hold",
    palettetwohandlog = "Record the two-handed hold",
    meleeleftspeed = "Other hand: swing speed needed", meleeleftext = "Other hand: extension needed",
    meleeleftreach = "Other hand: reach needed", meleeleftmaxspeed = "Other hand: ignore above this speed",
    meleeleftmaxreach = "Other hand: ignore beyond this reach", meleelefttau = "Other hand: speed smoothing",
    meleeleftcooldown = "Other hand: rest after a punch", meleelefthold = "Other hand: punch hold time", reloadakmute = "Silence the game's reload sound",
    reloadakmimic = "Reload step sounds", reloadcoophide = "Keep the gun empty until you reload (co-op)",
    reloadhidesolo = "The same when playing alone", meleeleft = "Punch with your other hand too",
