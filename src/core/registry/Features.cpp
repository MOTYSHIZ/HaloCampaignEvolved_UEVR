...
const FeatureRow kFeatures[] = {
    ...
    { "meleeleft",    1, Tier::Experimental, "Melee and grenades", "Punch with your other hand",
      ...
      "meleeleftspeed,meleeleftext,meleeleftreach,meleeleftmaxspeed,meleeleftmaxreach,meleelefttau,meleeleftcooldown,meleelefthold",
