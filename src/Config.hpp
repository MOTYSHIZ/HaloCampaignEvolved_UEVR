...
#include "core/config/ConfigTypes.inl"   // the fork's cfg value types (core)
...
struct Config {
    ...
    #include "core/config/ConfigFields.inl"   // the fork's cfg fields (core, read by features and core)
};
