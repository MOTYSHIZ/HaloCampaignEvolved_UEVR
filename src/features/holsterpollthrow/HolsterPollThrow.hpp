...
// object, and carries the throw experiments (throwdump, grenhand, greninstant; the create_projectile
// parts are dev builds only).
//
// FEATURE holsterpollthrow (Experimental). Hook slots: parse_key (holsterpollthrow, gripmaskl,
// gripmaskr, throwdump, grenhand, greninstant, grenbackdate, grenspeed), xinput_note_buttons,
